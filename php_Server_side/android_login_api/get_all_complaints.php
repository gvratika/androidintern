...
// get all complaints from complaints table

$result = mysql_query("SELECT pid, $searchBy FROM complaints WHERE $searchBy LIKE '%$keyword%' ORDER BY created_at DESC") or die(mysql_error());
